  ...
  mtext(text=round(seq(min(link.v), max(link.v), len=5), 1), side=1, line=0.3, at=seq(1, col.len, len=5), las=0, cex=0.8)
    ...
    ui <- shinyUI(dashboardPage(
      ...
      sidebarMenu(
        ...
        htmlOutput("edge"),
        div(style="display:inline-block;width:75%;text-align:left;",textInput("color.net", "Color scheme:", "purple,yellow,blue", placeholder="Eg: purple,yellow,blue", width=200)),
