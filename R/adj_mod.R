...
#' @return A list containing the adjacency matrix and module assignment, both of which are also automatically saved in the directory "local_mode_result" as "adj.txt" and "mod.txt" respectively. 
