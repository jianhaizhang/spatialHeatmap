...
#' @param dir The path where the directory "local_mode_result/" is created automatically to save resulting files "adj.txt" and "mod.txt". This argument should be the same with that from the function "filter.data" so that the processed data matrix generated by "filter.data" is saved in the same location. The default is NULL.
...
adj.mod <- function(data, type, minSize=15, dir=NULL) {
