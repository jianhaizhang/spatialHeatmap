...
#' library(SummarizedExperiment); expr <- as.matrix(expr); expr <- SummarizedExperiment(assays=list(expr=expr), rowData=ann, colData=con)  
...
filter_data <- function(data, pOA=c(0, 0), CV=c(0, Inf), dir=NULL) {
