...
<font style="color:blue">
Manual cluster labels are exclusively included in the `cluster` column in the `colData` slot by the function `manual_cluster`, which does not interfere with existing columns.    
</font>
