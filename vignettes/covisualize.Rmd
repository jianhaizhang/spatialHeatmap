...
are provided here. Here users can assign cell groups manually or by clustering
...
demonstration uses the same single cell and aSVG data as the annotation example above. The only difference is an additional clustering step.
