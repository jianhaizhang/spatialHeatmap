...
To assign the cell types from single cell experiments with their source tissues, the 
following describes three main methods available to the user, including 
annotation-based, manual and automatic. 
