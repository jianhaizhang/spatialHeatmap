...
legent of the corresponding figure. The text was far too long and contained a lot 
of detail that doesn't be long in section of vignette that is supposed to be a tutorial.
In addition, I wasn't able to understand several parts making it impossible for 
me to revise your write-up. So please fill in additional detail that is required 
under the three steps above but be consise and focus on the essential and leave out 
the exceptions. 

A few questions I have are: (1) in many cases you say some step has been
optimized but then you don't give the name of the method that has actually been
chosen. For instance, what normalization method, what embedding method and most
importantly what method for co-clustering is then actually been used? So keep it short
but mention those relevant details. (2) As described you seem to have performed
the embedding separatedly on the single cell and bulk data, but combine them
for the coclustering. Are you sure this is valid. I would be very concerned
that those embeddings are relative data that need to be generted jointly on
both to remain compareable. Perhaps I am misunderstanding? (3) The purpose of the
clustering step and co-clustering steps are not clearly defined. The reader will 
think they are the same or just get confused. 
</p>
...
please revise the figure 7 above accordingly. PLEASE keep it simple and clear.
...
<p style="color:red">That's how far I could edit your text. 
</p>
