---
itle: "Co-visualizing tissue and single cell embedding plots"
...
To obtain reasonably robust default settings for co-clustering, several parameters shown in Table \@ref(tab:optPar) are optimized, where bold text indicates optimal settings that are treated as robust default settings. The reason to choose these parameters is they are most relevant to the co-clustering workflow. The details of this optimization are given
...
df.opt <- cbind(
Parameter=c('dimensionReduction', 'topDimensions', 'graphBuilding', 'clusterDetection', 'minSimilarity'),
Settings=c( 
'**denoisePCA** (**PCA**, scran), runUMAP (UMAP, scater)', 
'5 to 40 at interval of 1 (**12**)', 
'**buildKNNGraph** (**knn**), **buildSNNGraph** (**snn**) (scran)', 
'**cluster_walktrap** (**wt**), cluster_fast_greedy (fg), cluster_leading_eigen (le)', 
