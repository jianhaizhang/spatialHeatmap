...
data, but combine them for the coclustering. Are you sure this is valid. I
would be very concerned that those embeddings are relative data that need to be
generted jointly on both to remain compareable. Perhaps I am misunderstanding?
(3) The purpose of the clustering step and co-clustering steps are not clearly
defined. The reader will think they are the same or just get confused. </p>
