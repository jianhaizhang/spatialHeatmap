...
via their group labels to the the corresponding tissue features in an aSVG image. If
...
`assays`, `colData`, `rowData`, and `reducedDims` contain expression data,
...
the same group label will then be colored the same. When coloring by tissues
