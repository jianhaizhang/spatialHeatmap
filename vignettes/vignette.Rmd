...
```
^[Thomas-Comment: the legend text should provide a brief overview of what is shown
...
has been included as a sample aSVG file of the `spatialHeatmap` package. Detailed 
instructions on generating custom aSVG images are provided in the 
...
The unique set of the matching sSVG files can be returned as follows.   
