...
feature and one species match, ^[<font color='blue'>jianhai-comment: at least one feature cannot be guarenteed, since the SVG repo is not huge. "To return all possible matching aSVGs" is more accurate.</font>] the argument `keywords.any` is set to `TRUE` by
