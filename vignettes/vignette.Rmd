...
clustering/WGCNA and the only plot the target gene in the context of a single
cluster/module. This is hugely inefficient compared to doing it only for the nearest
neighbors instead. Just think about if a user imports an expression matrix for
all transcripts from human. With your approach they will not be able to complete this
step since they will run out of memory on their system.]</font>
