...
(_e.g._ gene modules) sharing related expression patterns, including matrix heatmaps
...
the `SummarizedExperiment` container is populated with the gene expression
