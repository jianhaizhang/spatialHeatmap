...
The result from the previous step is stored in a list where the first component contains
the assay matrix subsetted to the genes sharing similar assay profiles as the query genes 'RCA' 
and 'HRE2'. The second slot contains the corresponding correlation matrix. ^[Again why would you 
compute the full similarity matrix for all genes in the assay and then even return it heer. If 
you need to return it, then compute it only for the filtered results meaning it should have 
dim= 62 x 62 and not 319 x 319.]
