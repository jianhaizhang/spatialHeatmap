...
corresponding spatial features of an anatomical map. Via a user definable color
gradient, the gene expression values are represented by characteristic colors
and plotted onto the corresponding tissue or cell samples profiled in an assay. 
This core functionality is called spatial heatmap. It is enhanced with
...
a population data plotted onto geographic maps. This level of flexibility is
