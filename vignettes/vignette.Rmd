...
is confusing that you are not mentioning here your custom aSVG repos.] It
contains annatomical aSVG images from different species. These SVG images are 
also used by the Expression Atlas database. If users cannot find a target aSVG 
in this repository, we have developed a step-by-step [SVG
...
Finally, the features are updated in the aSVG file(s) located in the `~/test` directory.
