...
path where the HTML, SVG image and move files will be stored.  Each HTML file
...
The following example saves the interactive HTML file(s) and video under the 
a directory named `~/test`.  

<!--
The following code chunk is not evaluated to avoid local write of files.
-->
```{r eval=FALSE, echo=TRUE, warnings=FALSE }
