...
these identifiers one or many feature types can be colored simultaneously in an
aSVG according to biological experiments assaying the corresponding feature
types with the required spatial resolution. Correct assignment of image
...
values is controlled by a color gradient parameter. To interpret the meaning of
the colors, the corresponding color key can be included in the spatial heatmap
