...
^[ThG: the interactive mode doesn't work for me. Am I supposed to get a URL like under
the network plot? Right now it opens RStudio but doesn't show there anything.] 
...
^[ThG: color scheme is a poor choice since the labels are unreadable in the dark brown 
nodes. Also the color scheme is not explained.]  
...
```
^[ThG: the interactive view shows only an empty shiny like window. Even when changing
the settings in the menu on the left nothing happens.]
