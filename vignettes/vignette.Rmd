...
provided in the [Supplement Section](#sup) of this vignette. 
...
corresponding features in an aSVG image. The image chosen for this
...
present in the aSVG, the `returnSVGFeatures()` function can be used.
...
`spatial_hm` is used translate the numbers to colors based on a user definable color 
key and then paint them onto the corresponding features in the aSVG image. 
