...
own repository, where users can contribute their aSVG images that are 
...
(Figure \@ref(fig:toyshm)) only three features in `my_vec` ('occipital_lobe', 
'parietal_lobe', and 'temporal_lobe') have matching entries in the corresponding 
aSVG. 
