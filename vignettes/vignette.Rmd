...
corresponding color key is included in the spatial heatmap plots.  Additional
...
directly. The aSVG images developed by this project (*e.g.* the Arabidopsis Shoot in Figure \@ref(fig:shshm)) are deposited in [GirkeLab SVG Repository](https://github.com/jianhaizhang/SVG_tutorial_file/tree/master/GirkeLab_SVG_Repo), where users can contribute their aSVG images that are 
formatted according to our guidlines.   

<font color='blue'>jianhai_comment: repo added.</font>
