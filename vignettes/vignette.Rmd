...
corresponding features in an aSVG image. The image chosen for this example is
from the human brain. The latter has been included in this package for testing
purposes. The path to the file of this image on a user's system can be obtained 
...
returned as a message printed to the R console. This behavior can be turned off 
