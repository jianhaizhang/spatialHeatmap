...
the user. This core functionality is called _spatial heatmap_. It is enhanced
with gene network visualization tools, including matrix heatmaps combined with
