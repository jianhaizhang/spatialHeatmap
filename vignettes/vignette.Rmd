...
version. In this network nodes and edges represent genes and adjacencies between them, 
respectively. The thickness of the edges denotes the adjacency levels, while the size of 
...
^[<font color='red'>ThG: color scheme is a poor choice since the labels are unreadable in the dark brown 
...
the settings in the menu on the right nothing happens.</font>]
