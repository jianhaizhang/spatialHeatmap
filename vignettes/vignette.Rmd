...
features mapped in anatomical images according to a numeric color key. The color
scheme used to represent the gene expression values can be customized by the
user. This core functionality is called spatial heatmap. It is enhanced with
gene network visualization tools, including matrix heatmaps combined with
