---
title: "spatialHeatmap: Intuitively Visualise Data Matrix on SVG Image"
...
In this vignette, firstly the Spatial Heatmap is exhibited with 4 gene expression (RNA-seq and microarray) examples, i.e. [Human Brain](#hum), [Mouse Organ](#mus), [Chicken Organ](#chk), [Arabidopsis Shoot](#shoot). Usage on other data type is in a similar way. Then the Matrix Heatmap, Network, and  Shiny app are presented. Next, the details of plotting spatial heatmaps are explained on the Human Brain example.  
