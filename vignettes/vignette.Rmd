...
any shape. For plotting spatial heatmaps, Scalable Vector Graphics (SVG) have
...
numerical information in images. SVG is based on XML formatted text describing
all lines, shapes and text in images.  In case of biological images the shapes
