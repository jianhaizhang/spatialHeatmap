...
directly. The aSVG images developed by the `spatialHeatmap` project are available in its
own [repository](https://github.com/jianhaizhang/SVG_tutorial_file/tree/master/svg_repo), 
where users can contribute their aSVG images that are formatted according to our 
guidlines.^[Jianhai will provide here a repos name later.] 
