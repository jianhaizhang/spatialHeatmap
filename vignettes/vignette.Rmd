...
2. In sample/condition names, a sample name is followed by double underscore "__" then the condition. For example, in the column name "epidermis__140mM_1h" in [Table 1](#table), "epidermis" is the sample and "140mM_1h" is the condition. 
