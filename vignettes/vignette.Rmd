...
can export them from R to a tabular file with the `filter_data` function, where
the user specifies the directory path under the `dir` argument and a tablular
file in TSV format (`customData.txt`) will be exported to this directory. The
column names in this file preserve the experimental design information from the
