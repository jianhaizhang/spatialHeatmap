...
stages where each one of them is represented by its own aSVG image. In addition to
static SHM representations, one can visualize them in form of dynamic animations
with a rich set of interactive functionalities, such as zooming and video download 
options.
