...
_spatial heatmap_ (SHM) plot. Additional important functionalities include
...
items with related abundance profiles using matrix heatmaps combined with hierarchical clustering 
and network representations (SCE), and to co-visualize single cell embedding
results with SHMs (SCSHM-CoViz). The latter functionality is described in a
a separate vignette called.     
...
SHMs are covered using the chosen Human brain data set as an example.  
