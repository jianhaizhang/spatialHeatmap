...
svg.clp.a <- '~/SVG_tutorial_file/svg_repo/coleoptile/coleoptile_ANT.svg'
shm.df <- spatial_hm(svg.path=svg.clp.a, data=se.fil.clp, ID=c('Os12g0630200', 'Os12g0628600'), height=0.7, legend.r=1.5, legend.key.size=0.02, legend.text.size=12, legend.nrow=8, ncol=1)
