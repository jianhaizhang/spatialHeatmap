...
and raster image paths, respectively. Raster images are optional and only required to
include photographic image components in SHMs (Figure \@ref(fig:overCol)).  
...
results are cached in `~/.cache/shm`.   
