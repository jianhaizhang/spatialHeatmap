...
shm.lis <- spatial_hm(svg.path=svg.hum, data=my_vec, ID='testing', ncol=1, height=0.9, width=0.8, sub.title.size=20, legend.nrow=2, ft.trans=c('g4320'))
```
...
spatial_hm(svg.path=svg.hum, data=se.fil.hum, ID=c('ENSG00000268433'), lay.shm='gene', ncol=2, width=1, height=1, legend.r=0.8, legend.nrow=2, ft.trans=c('g4320'), lis.rematch=remat.hum)
```
...
shm.lis <- spatial_hm(svg.path=svg.mus, data=se.fil.mus, ID=c('ENSMUSG00000000037'), height=0.7, legend.width=0.7, legend.text.size=10, sub.title.size=9, ncol=3, ft.trans=c('skeletal muscle', 'path4204'), legend.nrow=4, line.size=0.2, line.color='grey70')
```
...
spatial_hm(svg.path=svg.mus, data=se.fil.mus, ID=c('ENSMUSG00000000037'), height=0.6, legend.text.size=10, sub.title.size=9, ncol=3, legend.ncol=2, line.size=0.1, line.color='grey70', ft.trans='path4204')
```
...
spatial_hm(svg.path=c(svg.sh1, svg.sh2), data=df.random, ID=c('gene1'), width=0.7, legend.r=0.2, legend.width=1, preserve.scale=TRUE, bar.width=0.09, line.color='grey50') 
```
...
spatial_hm(svg.path=svg.mus, data=deg.lis.mus$deg.table, ID=c('ENSMUSG00000026764', 'ENSMUSG00000025479'), legend.r=1, legend.nrow=3, sub.title.size=6.1, ncol=3, bar.width=0.09)
```
...
spatial_hm(svg.path=svg.mus, data=deg.all.mus$deg.table, ID=c('ENSMUSG00000111977', 'ENSMUSG00000097960'), legend.r=1, legend.nrow=3, sub.title.size=9, ncol=3, bar.width=0.08)
```
...
spatial_hm(svg.path=svg.hum, data=vec, ID='testing', ncol=1, legend.r=1.2, sub.title.size=14, ft.trans='g4320')
```
